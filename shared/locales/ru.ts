export default {
  ...
  advantages: {
    no_logs: {
      ...
      text: "FRKN обеспечивает полную конфиденциальность вашей онлайн-активности. Мы не отслеживаем, не передаём и не продаем вашу и��формацию. Ваши личные данные не сохраняются, и мы не используем cookie-файлы. Для подключения требуется только номер учётной записи — без необходимости ввода паролей, email или телефона.",
    },
    open_source: {
      title: "Open source",
  ...
  app: {
    ...
    registration: {
      ...
      description: {
        part1:
          "FRKN обеспечивает полную анонимность без сбора личных данных. При регистрации вам б��дет предоставлена уникальная мнемофраза из 12 слов.",
      ...
      confirm_dialog: {
        title: "Подтвердите, что вы ��отовы к созданию мнемофразы",
        button: "Сгенерировать",
        text: "Ваша уникальная мнемофраза готова к показу. Пожалуйста, обратите внимание, что она будет отображена только один раз. Рекомендуем сразу же записать ил�� скопировать фразу и сохранить ее в надежном месте. К сожалению, в случае утери мы не сможем восстановить эту фразу, даже через службу поддержки. Без нее доступ к аккаунту будет невозможен. Вы готовы просмотреть и сохранить вашу мнемофразу?",
        confirm: "Продолжить",
        cancel: "Отменить",
      },
    },
    ...
    connect: {
      wg: "Для стран с минимальной цензурой. Когда просто хочется повысить уров��нь приватности",
      xray: "Для стран с высокой цензурой (РФ, Беларусь, Китай, Иран) для обхода блокировок",
      create: "Создать",
      wg_alert: {
        title: "Нестабильное подключение к WireGuard",
        description:
          "WireGuard может работать с перебоями из-за блокировок. Для надежного соединения используйте XRay протокол.",
      },
      table: {
        title: "Подключения",
        protocol: "Протокол",
    ...
    dashboard: {
      wg_description:
        "Для стран с минимальной цензурой. Когда просто хочется повысить уровень приватности",
      xray_description:
        "Для стран с высокой цензурой (РФ, Беларусь, Китай, Иран) для обхода блокировок",
      wg_alert: {
        title: "Нестабильное подключение к WireGuard",
        description:
          "WireGuard может работать с перебоями из-за блокировок. Для надежного соединения используйте XRay протокол.",
      },
      your_configurations: "Ваши конфигурации",
      add_new_configuration: "Добавить новую конфигурацию",
      loading: "Загрузка...",
      create_vpn_connection: "Создать VPN-соединение",
      setup_vpn_connection:
        "Настройте VPN-соединение и начните безопасный просмотр",
      select_protocol: "Выберите протокол",
      select_server: "Выберите сервер",
      choose_server: "Выберите сервер",
      only_one_server:
        "В бесплатном плане доступно только одно серверное соединение",
      create_connection: "Создать соединение",
      upgrade_plan:
        "Вы уже имеете WireGuard соединение. Обновите план, чтобы создать новое",
      no_active_configs: "У вас еще нет активных VPN-конфигураций",
      create_first_config:
        "Создайте свою первую конфигурацию, чтобы начать безопасный и анонимный просмотр. Это займет всего пару минут!",
      create_first_connection: "Создать первое соединение",
      limit: "Лимит",
      used_traffic: "Использованный трафик",
      copy: "Копировать",
      download: "Скачать",
      country_validation_error: "Страна обязательна",
      table: {
        protocol: "Протокол",
        country: "Страна",
        limit: "Лимит",
        traffic: "Трафик",
        reset_limit_strategy: "Сброс лимита",
        actions: {
          show_qr: "Показать QR",
