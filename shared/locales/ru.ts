export default {
  ...
  app: {
    ...
    dashboard: {
      vpnTableDescription_1: "Эта таблица предоставляет VPN-серверы с ",
      vpnTableDescription_2:
        " дневным лимитом. Скопируйте ссылку конфигурации в рекомендуемое VPN-приложение или отсканируйте QR-код с помощью поддерживаемого VPN-клиента для подключения.",
      title: "Соединения",
      xrayDescription:
        "Более продвинутый VPN-протокол, предлагающий дополнительные функции, такие как более сильное шифрование и обфускация. Используйте предоставленную ссылку в клиенте VPN, поддерживающем XRay, для безопасного подключения.",
      shadowsocksDescription:
        "Легковесный прокси-протокол, идеальный для обхода интернет-цензуры. Скопируйте ссылку конфигурации или отсканируйте QR-код в приложении, совместимом с Shadowsocks, для быстрого подключения.",
