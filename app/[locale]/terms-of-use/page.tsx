    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <p className="mb-4">
          ...
          frkn.org/blog как минимум за один месяц до их вступления в силу. Если
          вы хотите воспользоваться правом отказаться от таких изменений, вы
          должны прекратить использование сервиса (для возвратов см. ниже).
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Мы не блокируем и не фильтруем домены, за исключением случаев, когда
          это запрашивается владельцем IP-адреса или когда известные адреса
          ботнетов приводят к тому, что наши серверы блокируются
          хостинг-провайдерами. Мы перехватываем DNS-запросы (порт 53) для
          предотвращения утечек DNS.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          вместе с приложением FRKN VPN или с другим клиентом WireGuard, XRay
          или OpenVPN и нашими загружаемыми конфигурационными файлами.
        </p>
        <p className="mb-4">
          ...
          XRay, OpenVPN). Мы не несем ответственности за работу,
          функциональность, безопасность или совместимость этих приложений.
        </p>
        <p className="mb-4">
          Один аккаунт можно использовать на 5 устройствах. Вам запрещено
          использовать этот сервис для предоставления сервиса, аналогичного
          тому, который предоставляется FRKN, или других сервисов, где VPN
          составляет значительную часть сервиса.
        </p>
        ...
        <p className="mb-4">
          Пользователь несет ответственность за сохранность данных для
          подключения к сервису. В случае их утраты или компрометации,
          пользователь обязан незамедлительно уведомить администрацию.
        </p>
        ...
        <p className="mb-4">
          ...
          покупке через App Store или официального реселлера. Сервис
          активируется, как только платеж будет зачислен, и время начнет
          отсчитываться. Эти условия истекают в конце оплаченного периода.
        </p>
        ...
        <p className="mb-4">
          ...
          30-дневный период начинается с момента оплаты. Если у вас есть жалобы
          на сервис после этого периода, оставшееся время может быть возмещено.
        ...
        <p className="mb-4">
          FRKN VPN оставляет за собой право изменять сервис, обновляя
          программное обеспечение или внося изменения в определенные функции. Мы
          постараемся предотвратить прерывания и дефекты в работе сервиса и на
          нашем сайте. Несмотря на наши усилия, сервис предоставляется на
          условиях «как есть» и «по мере доступности», и мы не гарантируем, что
          сервис будет доступен в любое время, а также точность сервиса или
          любого материала, предоставленного сервисом или на сайте FRKN. Вы
          несете полную ответственность за использование сервиса.
        </p>
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <p className="mb-4">
        ...
        notified through a prominent announcement on frkn.org/blog at least one
        month before they take effect. If you wish to exercise your right to opt
        out of such changes, you must stop using the service (for refunds, see
        below).
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        We are not the developer, owner, or provider of third-party applications
        used to connect to the service (WireGuard, XRay, OpenVPN). We are not
        responsible for the operation, functionality, security, or compatibility
        of these applications.
      </p>
      <p className="mb-4">
        One account can be used on 5 devices. You are prohibited from using this
        service to provide a service similar to that provided by FRKN, or other
        services where VPN constitutes a significant part of the service.
      </p>

      <h2 className="text-2xl font-semibold mb-4">Security</h2>
      <p className="mb-4">
        The user undertakes to independently take appropriate measures to ensure
        the security of their device and prevent unauthorized access by third
        parties.
      </p>
      <p className="mb-4">
        The user agrees to use the service and website only for lawful purposes
        and by lawful means, taking into account local legislation.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        We do not offer refunds for cash payments. Refund requests for purchases
        made through the App Store or reseller must be directed to them
        directly.
      </p>
      <p className="mb-4">
        In the case of refunds for purchases made in cryptocurrency, the refund
        will be made to the same cryptocurrency wallet from which the payment
        was made.
      </p>

      <h2 className="text-2xl font-semibold mb-4">Privacy</h2>
      <p className="mb-4">
        We want you to remain anonymous when using our service, so our policy is
        to never store activity logs or metadata and minimize data storage.
      </p>
      <p className="mb-4">
        However, when paying by bank transfer and Stripe, your bank and payment
        providers will process your personal data as controllers of such
        processing. You can read more about payment providers on their websites.
      </p>
      ...
      <p className="mb-4">
        ...
        website. Despite our efforts, the service is provided on an "as is" and
        "as available" basis, and we do not guarantee that the service will be
        available at any time, nor the accuracy of the service or any material
        provided by the service or on the FRKN website. You are fully
...
export function generateMetadata({ params: { locale } }: Props): Metadata {
  return {
    ru: { title: "Условия использования – FRKN VPN" },
    en: { title: "Terms of Service – FRKN VPN" },
    es: { title: "Términos de Servicio – FRKN VPN" },
    pt: { title: "Termos de Serviço – FRKN VPN" },
    fr: { title: "Conditions d'Utilisation – FRKN VPN" },
    de: { title: "Nutzungsbedingungen – FRKN VPN" },
    tr: { title: "Hizmet Şartları – FRKN VPN" },
  }[locale]
}
